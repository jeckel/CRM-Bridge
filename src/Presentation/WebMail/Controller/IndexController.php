...
namespace App\Presentation\WebMail\Controller;
...
class IndexController extends AbstractController
{
    ...
    {
        return $this->render(
            '@webmail/mailboxes_embed.html.twig',
    ...
    public function listMails(
        ...
        return $this->render(
            '@webmail/list_mails_embed.html.twig',
            [
    ...
    public function details(string $mailId, ImapMessageRepository $repository): Response
    {
        ...
        return $this->render('@webmail/mail_embed.html.twig', ['mail' => $mail]);
    }
    ...
    public function debug(string $mailId, ImapMessageRepository $repository, MailProvider $provider): Response
    {
        ...
        return $this->render(
            '@common/debug/dump_var.html.twig',
            ['var' => [
                'original' => $fullMail,
